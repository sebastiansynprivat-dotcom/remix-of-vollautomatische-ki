  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <style>{`
        ...
        .leitfaden-md h2 { font-size: 17px; font-weight: 700; margin: 28px 0 10px; color: var(--gold); letter-spacing: -0.2px; }
        ...
        .leitfaden-md code { background: hsla(0,0%,100%,0.06); padding: 1px 6px; border-radius: 4px; font-size: 12px; font-family: ui-monospace,SFMono-Regular,Menlo,monospace; color: var(--gold); }
        ...
        .leitfaden-md blockquote { border-left: 3px solid var(--gold); padding: 4px 14px; margin: 10px 0; color: var(--text-muted); background: hsla(40,30%,18%,0.15); border-radius: 0 6px 6px 0; }
        ...
        .leitfaden-md th { background: hsla(40,30%,18%,0.3); color: var(--gold); font-weight: 700; }
        .leitfaden-md hr { border: none; border-top: 1px solid hsla(0,0%,100%,0.08); margin: 22px 0; }
        .leitfaden-md a { color: var(--gold); text-decoration: underline; }
      `}</style>
    </div>
  );
}
