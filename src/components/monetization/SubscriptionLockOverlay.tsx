    ...
    <div style={{
      ...
      <div className="premium-card" style={{ padding: "16px 18px", textAlign: "center", maxWidth: 220 }}>
        <div style={{
          ...
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="2"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
        </div>
        <div style={{ color: "var(--text-strong)", fontSize: 13, fontWeight: 600, marginBottom: 2 }}>Exklusiver Inhalt</div>
        <div className="tabular" style={{ color: "var(--accent)", fontSize: 13, marginBottom: 10 }}>
          Ab {formatCurrency(price)} / Monat
        </div>
        <button onClick={handleSubscribe} className="accent-gradient-bg" style={{
